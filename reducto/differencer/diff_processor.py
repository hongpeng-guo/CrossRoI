...
class DiffProcessor:
    ...
    def __init__(self, thresh=.0, fraction=.0, segment_size=10):
        """
    ...
    def get_diff_vector(self, video_path):
        ...
        with VideoProcessor(video_path) as video:
            ...
            for frame in video:
                ...
                diff_value = self.cal_frame_diff(feat, prev_feat)
    ...
    def batch_diff(diff_value, diff_processors):
        ...
        for dp in diff_processors:
            ...
            while current <= total_frames:
                diff_delta = diff_integral[current-1] - diff_integral[last-1]
    ...
    def get_section():
        ...
        config.read('reducto/config/diff_config.ini')
...
class PixelDiff(DiffProcessor):
    ...
    def __init__(self, thresh=.0, fraction=.0):
        super().__init__(thresh, fraction)
        self.feature = 'pixel'
        self.name = f'{self.feature}-{self.thresh}-{self.fraction}'
